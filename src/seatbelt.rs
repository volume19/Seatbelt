...
impl Seatbelt {
    ...
    fn register_commands(&self, runtime: &mut Runtime) {
        ...
        runtime.register_command(Box::new(crate::commands::windows::HotfixesCommand::new()));
        runtime.register_command(Box::new(crate::commands::windows::LocalUsersCommand::new()));
        runtime.register_command(Box::new(crate::commands::windows::LocalGroupsCommand::new()));
        ...
        runtime.register_command(Box::new(crate::commands::windows::ARPCacheCommand::new()));
        runtime.register_command(Box::new(crate::commands::windows::NamedPipesCommand::new()));
        ...
        runtime.register_command(Box::new(crate::commands::windows::LAPSCommand::new()));
        runtime.register_command(Box::new(crate::commands::windows::CredentialGuardCommand::new()));
        runtime.register_command(Box::new(crate::commands::windows::InternetSettingsCommand::new()));
        runtime.register_command(Box::new(crate::commands::windows::CertificatesCommand::new()));
        ...
        runtime.register_command(Box::new(crate::commands::windows::EventLogsCommand::new()));
        runtime.register_command(Box::new(crate::commands::windows::WMIEventFiltersCommand::new()));
        runtime.register_command(Box::new(crate::commands::windows::RecycleBinCommand::new()));
        runtime.register_command(Box::new(crate::commands::windows::ExplicitLogonEventsCommand::new()));
